Design a 2nd order analog highpass filter from the general s-transform equation and then derive its digital equivalent using the substitution: s+a → 1−e−aT z−1. For this filter:
<br>
